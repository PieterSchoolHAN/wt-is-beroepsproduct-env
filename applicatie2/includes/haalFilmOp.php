...
$query = $db->prepare("select title as Titel, description as Beschrijving, genre_name as Genre, duration as Duur, publication_year as Jaar, cover_image as Cover, trailer as Trailer, PS.lastname as Achternaam, PS.firstname as Voornaam, PD.lastname as achternaamDirector, PD.firstname voornaamDirector
from Movie M
