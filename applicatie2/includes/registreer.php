...
function registreerGebruiker($gegevens)
{
    ...
    $query = $verbinding->prepare("INSERT INTO Customer VALUES (:email, :admin,  :achternaam, :voornaam, :betaalmethode, :kaartnummer, :abonnementstype, :startabbo, :eindeabbo, :uname, :pword, :land, :geslacht, :geboortedatum)");
    $query->execute([':email' => $gegevens['email'], ':achternaam' => $gegevens['achternaam'], ':voornaam' => $gegevens['voornaam'], ':betaalmethode' => $gegevens['betaalmethode'], ':kaartnummer' => $gegevens['kaartnummer'], ':abonnementstype' => $gegevens['abonnementstype'], ':startabbo' => $gegevens['startabbo'], ':eindeabbo' => $gegevens['eindeabbo'], ':uname' => $gegevens['uname'], ':pword' => $gegevens['pword'], ':admin' => $gegevens['admin'], ':land' => $gegevens['land'], ':geslacht' => $gegevens['geslacht'], ':geboortedatum' => $gegevens['geboortedatum']]);
    return true;
}
